        ...
        <form id="formularioP" onSubmit={handleSubmit} autoComplete="off">
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              onBlur={handleBlur}
              className={
                errors.titulo && touched.titulo ? `${styles.inputerror}` : ""
              }
            ></Form.Control>
          </Form.Group>
          ...
          <Form.Group type="text" className="mb-3">
            ...
            <Form.Control
              ...
              onBlur={handleBlur}
              className={
                errors.portada && touched.portada ? `${styles.inputerror}` : ""
              }
            />
          </Form.Group>
          ...
          <Row>
            <Col>
              <Form.Group>
                ...
                <Form.Select
                  ...
                  onBlur={handleBlur}
                  className={
                    errors.categoria && touched.categoria ? `${styles.inputerror}` : ""
                  }
                  style={{
                    fontsize: "1rem",
                    fontweight: "bold",
            ...
            <p className={`${styles.errorMsg}`}>{errors.categoria}</p>
          )}
            </Col>
            ...
            <Col>
              <Form.Group>
                ...
                <Form.Select
                 ...
                 onBlur={handleBlur}
                 className={
                  errors.subcategoria && touched.subcategoria ? `${styles.inputerror}` : ""
                }
                  style={{
                    fontsize: "1rem",
                    fontweight: "bold",
            ...
            <p className={`${styles.errorMsg}`}>{errors.subcategoria}</p>
          )}
            </Col>
          </Row>
          ...
          <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
            ...
            <Form.Control
              ...
              className={
                errors.descripcion && touched.descripcion ? `${styles.inputerror}` : ""
              }
            />
          </Form.Group>
          {errors.descripcion && touched.descripcion && (
            <p className={`${styles.errorMsg}`}>{errors.descripcion}</p>
          )}
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              className={
                errors.fecha && touched.fecha ? `${styles.inputerror}` : ""
              }
            />
          </Form.Group>
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              className={
                errors.objetivo && touched.objetivo ? `${styles.inputerror}` : ""
              }
            />
          </Form.Group>
